...
urlpatterns = [
    ...
    path('create/variables/', views.CreateVariables.as_view()),
    ...
    path('client/edit/<int:pk>/', views.UpdateClient.as_view()),
    path('client/<int:pk>/', views.DetailClient.as_view()),
    path('tables/<int:pk>/', views.Taxes.as_view()),
    path('debtors/', views.Debtor.as_view()),
]
