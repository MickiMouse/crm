            ...
            <div class="col-12">
                ...
                >
                    <template v-slot:cell(short_name)="data">
                        <div class="text-nowrap" style="cursor: pointer" @click="getDetails(data.item.pk)">{{data.item.short_name}}</div>
                    </template>
                    ...
                    <template v-slot:cell(actions)="data">
                        <div class="d-flex">
                            <action-button class="mx-1" :icon="['far' ,'comment-alt']"/>
                            <action-button class="mx-1" :icon="['far' ,'bell']"/>
                            <action-button class="mx-1" :icon="['far' ,'edit']"/>
                        </div>
                    </template>
                </b-table>
            </div>
...
<script>
    ...
    export default {
        name: "ClientsTable",
        components: {ActionButton, ExpandTable},
        data(){
            return{
